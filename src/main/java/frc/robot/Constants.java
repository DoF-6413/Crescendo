  ...
  public final class VisionConstants {
    ...
    public static final Transform3d LEFT_CAMERA_ROBOT_OFFSET =
        new Transform3d(
            ...
            new Rotation3d(Math.PI, 0, -Math.PI / 2 - Units.degreesToRadians(44.66185)));
    ...
    public static final Transform3d RIGHT_CAMERA_ROBOT_OFFSET =
        new Transform3d(
            new Translation3d(-Units.inchesToMeters(10.541), -Units.inchesToMeters(11.695), 0),
            new Rotation3d(Math.PI, Units.degreesToRadians(37.49265), Math.PI + Units.degreesToRadians(20.9849) + Units.degreesToRadians(35)));
