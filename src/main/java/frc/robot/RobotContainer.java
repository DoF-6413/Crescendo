...
public class RobotContainer {
    ...
    private final CommandXboxController driverController = new CommandXboxController(
            OperatorConstants.DRIVE_CONTROLLER);
    ...
    public RobotContainer() {
        ...
        m_headingController = new HeadingController(() -> m_poseEstimator.AngleForSpeaker(), m_poseEstimator);
    ...
    private void configureButtonBindings() {
        ...
        auxController
                .y()
                .onTrue(
                        new AimShooter(m_shooterSubsystem, m_wristSubsystem, m_armSubsystem, m_poseEstimator, m_feederSubsystem));
