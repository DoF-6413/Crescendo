...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("actuatorIn", new InstantCommand());
    NamedCommands.registerCommand("UTB", new InstantCommand());
    NamedCommands.registerCommand("actuatorOut", new InstantCommand());
    // NamedCommands.registerCommand(
    //     "shoot",
    //     new InstantCommand(
    //         () -> m_shooterSubsystem.setShooterMotorPercentSpeed(.5))); // update porcentage of
    // seed
  ...
  private void configureButtonBindings() {
    ...
    //     .y()
    //     .onTrue(
    //         new AmpScore(m_armSubsystem, m_wristSubsystem, m_feederSubsystem,
    // m_shooterSubsystem))
    //     .onFalse(
    //         new InstantCommand(
    //             () -> {
    ...
    // // NOTE: In sim the angle that the arm stops at changes and isnt near the min/max angles we
    // set
