...
public class LineShot extends SequentialCommandGroup {
  /** Creates a new SpeakerShoot. */
  public LineShot(Feeder feeder, Shooter shooter, Wrist wrist, Arm arm) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new PositionToShoot(feeder, shooter, wrist, 5, 4000), // TODO Update angle
