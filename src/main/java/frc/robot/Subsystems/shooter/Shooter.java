...
public class Shooter extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("BottomError", setpointRPM - inputs.bottomShooterMotorRPM);
