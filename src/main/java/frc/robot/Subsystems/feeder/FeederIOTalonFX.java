...
public class FeederIOTalonFX implements FeederIO {
    ...
    public void updateInputs(FeederIOInputs inputs) {
        inputs.feederRPM = feederMotor.getVelocity().getValueAsDouble() / FeederConstants.GEAR_RATIO; // Gets the velocity of the Feeder motor, in RPM, and divides it by the gear ratio to obatin the RPM of the feeder itself
        ...
        inputs.feederTempCelsuis = new double[] {feederMotor.getDeviceTemp().getValueAsDouble()};
    }
    ...
    public void setFeederPercentSpeed(double percent) {
        feederMotor.setVoltage(percent);
    }
