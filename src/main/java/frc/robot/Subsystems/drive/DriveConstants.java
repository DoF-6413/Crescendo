...
public final class DriveConstants {
    ...
    /** Chassis Width, distance between the centerline of two adjacent wheels
     * same for length and width because drivetrain is square
     */
    ...
    /**
     * Max Speed the Robot Can Rotate (rads/s) 
     * Angular Speed is linear speed divided by radius of the "circle" an object moves around (v = wr)
     * The "radius" of the Swerve Drive is equal to half of the distance from one corner to
     * the opposite corner, calculated by sqrt2 * half the track width
     */
    ...
    /** Sim Constants */
    public static final double DRIVE_J_KG_METERS_SQUARED = 0.0003125; // moment of inertia of wheel when driving
    public static final double STEER_J_KG_METERS_SQUARED = 0.0000158025413; // moment of inertia of wheel when turning
    ...
    /* 1: PDH, 2-5: Absolute Encoders, 6-9: Krakens (Drive), 10-13: Neos (Turn)
     * 14: UTB 15: OTB 16: Actuator 17 & 18: Climbers left and right 19: Indexer
     */
    ...
    /** returns P of PID constants for Drive Motors depending on whether the Module is an L3 (kraken) or L2 (neo) */
    ...
    /** returns S of feedforward constants for Drive Motors depending on whether the Module is an L3 or L2 */
    ...
    /** returns V of feedforward constants for Drive Motors depending on whether the Module is an L3 or L2 */
